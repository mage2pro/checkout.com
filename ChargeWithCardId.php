...
use Dfe\CheckoutCom\Patch\CardIdChargeCreate;
...
class ChargeWithCardId extends \Df\Payment\Charge {

	protected function cardid() {return $this[self::$P__CARDID];}

	/** @var string */
	protected static $P__CARDID = 'cardid';
	/**
	 * 2016-05-06
	 * @return CardIdChargeCreate
	 */
	private function _build() {
		/** @var CardIdChargeCreate $result */
		$result = new CardIdChargeCreate;
	...
	/**
	 * 2016-05-06
	 * @param CardIdChargeCreate $request
	 * @return void
	 */
	private function setProducts(CardIdChargeCreate $request) {
	...
	protected function _construct() {
        ...
        $this->_prop(self::$P__CARDID, RM_V_STRING_NE);
	}
	 ...
	 * @return CardIdChargeCreate
	 */
	public static function build(InfoInterface $payment, $cardId, $amount = null, $capture = true) {
		return (new self([
			self::$P__AMOUNT => $amount
			, self::$P__NEED_CAPTURE => $capture
			, self::$P__PAYMENT => $payment
			, self::$P__CARDID => $cardId
		]))->_build();
	}
}